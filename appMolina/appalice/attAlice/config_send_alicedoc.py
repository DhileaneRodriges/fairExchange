...
usage           : 
notes           :
compile and run :  cm770@morello-camb-3: $ python3 config_send_alicedoc.py
                :           -s morello-camb-3.sm.cl.cam.ac.uk 
                :           -f alicedoc_encrypted.txt 
                :
                :  cm770@morello-camb-3: $ python3 config_send_alicedoc.py
                :
...
class SSLserverfile():
    ...
    def start_server(self, server_Name, port_Number, ser_fileName):
        ...
        print("Sever has been started in Alice's attestable running on host: ", self.server_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--port_number", help="port number used by server", default="8080")
