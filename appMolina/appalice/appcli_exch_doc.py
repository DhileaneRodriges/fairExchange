...
notes           : I have tested only with "localhost" (i.e 127.0.0.1)
                : and port 8282
compile and run : % python3 appcli_exch_doc.py file_to_send 
                : Alternatively the main class of this module 
                : (test_appcli_exch_doc.py) can be tested by the testing
                : program test_SSLclientfile
                : 
                : % test_appcli_exch_doc.py # sends helloServer.txt by default 
                :
...
if __name__ == '__main__':
    ...
    #parser.add_argument("-s", "--server", help="Server, default is morello-camb-1.sm.cl.cam.ac.uk ", default= "morello-camb-1.sm.cl.cam.ac.uk")
    parser.add_argument("-s", "--server", help="Server, default is morello-camb-1.sm.cl.cam.ac.uk ", default= "localhost")
    parser.add_argument("-p", "--port", help="Server port, default is ", default=8282)
    parser.add_argument("file", help="name of file to send")
