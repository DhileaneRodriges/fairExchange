...
notes           : I have tested only with morello-camb-3.sm.cl.cam.ac.uk 
                ...
                : in current folder. 
                :
compile and run : cm770@morello-camb-3: $ python3 test_appser_exch_doc.py 
                :    -s morello-camb-3.sm.cl.cam.ac.uk 
                :    -p 8282 -f bobdoc_encrypted.txt
                ...
                :
                : Alternatively
                : cm770@morello-camb-3: $ python3 test_appser_exch_doc.py 
                :
...
from appser_exch_doc import  SSLserverfile 
...
def main():
  ...
  parser.add_argument("-s", "--server_name", help="host to run the server", default="localhost")
  parser.add_argument("-p", "--port_number", help="port used by server", default="8290")
  parser.add_argument("-f", "--file_to_send", help="file to send to client", default="bobdoc_encrypted.txt")
