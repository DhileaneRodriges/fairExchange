...
notes           : I have tested only with morello-camb-3.sm.cl.cam.ac.uk 
                ...
                : in current folder. 
                :
compile and run : cm770@morello-camb-3: $ python3 test_att_recv_bobdoc.py 
                :    -s localhost 
                :    -p 9290 -f alicedoc_encrypted.txt
                :
                : Alternatively
                : cm770@morello-camb-3: $ python3 test_att_recv_bobdoc.py 
                :
python_version  : Python 3.7.4 (v3.7.4:e09359112e, Jul 8 2019)      
                :
"""

from att_recv_bobdoc import SSLserverfile 
