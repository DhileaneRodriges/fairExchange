...
class SSLclientfile():
 ...
 def send_recv_file(self, fname): 
     ...
     try:
        ...
        print("cli_resp: ", cli_resp.decode("UTF-8")) 
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description="Bob's app that sends and receives a files")
    ...
    parser.add_argument("-f", "--file", help="File name to send", default="alicedoc_encrypted.txt")
