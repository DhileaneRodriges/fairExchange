"""
title           : test_app_send_alicedoc.py 
...
notes           :
compile and run :
                : cm770@morello-camb-1: $ py test_app_send_alicedoc.py 
                :      -s morello-camb-3.sm.cl.cam.ac.uk 
                :      -p 8290 -f alicedoc_encrypted.txt
                : cm770@morello-camb-1: $ py test_app_send_alicedoc.py 
                :
...
def main():
  ...
  parser.add_argument("-s", "--server", help="Host where Bob's attestablei run, default is localhost", default= "localhost")
