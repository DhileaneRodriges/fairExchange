...
usage           : 
notes           :
compile and run :  cm770@morello-camb-3: $ python3 appser_exch_doc.py 
                :           -s morello-camb-3.sm.cl.cam.ac.uk 
                :           -f bobdoc_encripted.txt 
                :
                :  cm770@morello-camb-3: $ python3 appser_exch_doc.py 
                :
...
if __name__ == '__main__':
    ...
    parser.add_argument("-f", "--file_to_send", help="Name of file to send to client", default="bobdoc_exch_doc.txt")
